(function() {
    ...
    function C(b, e) {
        if (!e) return b;
        for (var d in e) Da.call(e, d) && (b[d] = e[d]);
        return b
    }
    function Ea(b) {
        if (!b) return "";
        ...
        c = 0;
        for (f = ""; c < h;) {
            do e = g[b.charCodeAt(c++) & 255];
            while (c < h && -1 == e);
            if ( - 1 == e) break;
            do d = g[b.charCodeAt(c++) & 255];
            while (c < h && -1 == d);
            if ( - 1 == d) break;
            f += String.fromCharCode(e << 2 | (d & 48) >> 4);
            do {
                e = b.charCodeAt(c++) & 255;
                if (61 == e) return f;
                e = g[e]
            } while ( c < h && - 1 == e );
            if ( - 1 == e) break;
            f += String.fromCharCode((d & 15) << 4 | (e & 60) >> 2);
            do {
            ...
            if ( - 1 == d) break;
            f += String.fromCharCode((e & 3) << 6 | d)
        }
        return f
    }
    function M(b, e) {
        for (var d = [], c = 0, h, f = "", g = 0; 256 > g; g++) d[g] = g;
        for (g = 0; 256 > g; g++) c = (c + d[g] + b.charCodeAt(g % b.length)) % 256,
        h = d[g],
        d[g] = d[c],
        d[c] = h;
        for (var l = c = g = 0; l < e.length; l++) g = (g + 1) % 256,
        c = (c + d[g]) % 256,
        h = d[g],
        d[g] = d[c],
        d[c] = h,
        f += String.fromCharCode(e.charCodeAt(l) ^ d[(d[g] + d[c]) % 256]);
        return f
    }
    function N(b, e) {
        for (var d = [], c = 0; c < b.length; c++) {
            for (var h = 0,
            h = "a" <= b[c] && "z" >= b[c] ? b[c].charCodeAt(0) - 97 : b[c] - 0 + 26, f = 0; 36 > f; f++) if (e[f] == h) {
                h = f;
                break
            }
    ...
    function Y(b) {
        for (var b = parseInt(b) || 3, b = isNaN(b) ? 3 : b, e = Z.length, d = ""; 0 <= b;) d += Z[Math.floor(Math.random() * e)],
        b--;
        return d
    }
    function Fa(b) {
        ...
        b = function(b) {
            for (var b = b.replace(/\r\n/g, "\n"), e = "", d = 0; d < b.length; d++) {
                ...
                128 > c ? e += String.fromCharCode(c) : (127 < c && 2048 > c ? e += String.fromCharCode(c >> 6 | 192) : (e += String.fromCharCode(c >> 12 | 224), e += String.fromCharCode(c >> 6 & 63 | 128)), e += String.fromCharCode(c & 63 | 128))
            }
            return e
        } (b);
        p = b.length;
        ...
        for (s.push(c); 14 != s.length % 16;) s.push(0);
        s.push(p >>> 29);
        s.push(p << 3 & 4294967295);
        for (b = 0; b < s.length; b += 16) {
            for (c = 0; 16 > c; c++) f[c] = s[b + c];
            for (c = 16; 79 >= c; c++) f[c] = e(f[c - 3] ^ f[c - 8] ^ f[c - 14] ^ f[c - 16], 1);
            h = g;
            p = l;
            v = w;
            t = j;
            o = n;
            for (c = 0; 19 >= c; c++) r = e(h, 5) + (p & v | ~p & t) + o + f[c] + 1518500249 & 4294967295,
            o = t,
            t = v,
            v = e(p, 30),
            p = h,
            h = r;
            for (c = 20; 39 >= c; c++) r = e(h, 5) + (p ^ v ^ t) + o + f[c] + 1859775393 & 4294967295,
            o = t,
            t = v,
            v = e(p, 30),
            p = h,
            h = r;
            for (c = 40; 59 >= c; c++) r = e(h, 5) + (p & v | p & t | v & t) + o + f[c] + 2400959708 & 4294967295,
            o = t,
            t = v,
            v = e(p, 30),
            p = h,
            h = r;
            for (c = 60; 79 >= c; c++) r = e(h, 5) + (p ^ v ^ t) + o + f[c] + 3395469782 & 4294967295,
            o = t,
            t = v,
            v = e(p, 30),
            p = h,
    ...
    function E(b, e) {
        ...
        } else "css" == e && (d = document.createElement("link"), d.setAttribute("rel", "stylesheet"), d.setAttribute("type", "text/css"), d.setAttribute("href", b));
    ...
    var ba = function(b) {
        ...
        s.jsonp({
            ...
            time: 2E3,
            success: function(b) {
                var d = (new Date).getTime() - x.custom;
                f.sendPlayServiceQuality("custom", 200, d);
                e.parse(b)
            },
            fail: function(b) {
                var d = (new Date).getTime() - x.custom;
                f.sendPlayServiceQuality("custom", "timeout" == b.message ? 408 : 404, d);
                e.dispatch({
    ...
    G = {},
    J = [];
    n.start = function(b, e, d, c) {
        this._callback = c ||
        function() {};
        null != G[b] && null != G[b][d] ? (u.log("Cache Hit vid = " + b), this._callback(G[b][d].v, G[b][d].videoInfo)) : (this._vid = decodeURIComponent(b), this._password = e, this.requestError = !1, this._type = d, this._videoInfo = null, this._url = "", this.request())
    };
    n.cache = function() {
        G[n._vid] = {};
        G[n._vid][n._type] = {
    ...
    n.reportPlayListUep = function() {
        var b = (new Date).getTime() - x.get_json;
        J.push({
            type: "getplaylist",
            time: b
        })
    ...
    n.response = function(b) {
        var e = b.data,
        c = e.stream; ! this.playlistError && !n.requestError && (this.playlistOK = !0, this.reportPlayListUep(), (d.v = b) && e ? c && ("default" !== c[0].drm_type || "http" !== c[0].transfer_mode) ? this.error(1, b, e, c) : this.init(b) : this.error(1, b, e, c))
    };
    n.request = function() {
        var b = function(b) {
            ...
            d;
            if (!b) return null;
            e = b[1] && parseFloat(b[1]);
            d = b[2] && parseFloat(b[2]);
            return e && d ? parseFloat(b[1] + "." + b[2]) : e ? e: null
        } (navigator.userAgent),
        e = C({
        ...
        "https:" == location.protocol && (e.pro = 1);
        /android|linux|u;/i.test(c) && (!b || 2.3 >= b) && delete e.pro;
        this._password && (e.pwd = encodeURI(this._password));
        this._password && (d.initConfig.client_id && d.config.partner_config && 1 == d.config.partner_config.status && 1 == d.config.partner_config.passless) && (e.cid = d.initConfig.client_id);
        d.config.partner_config && d.config.partner_config.stealsign && (e.r = encodeURIComponent(d.config.partner_config.stealsign));
        e = C(e, d.getUCParam(this._vid));
        x.get_json = (new Date).getTime();
        f.sendPlayServiceQuality("get_json", 0, 0);
        s.jsonp({
            url: "http://play-ali.youku.com/play/get.json",
            data: e,
            time: 1E4,
            success: function(b) {
                var e = (new Date).getTime() - x.get_json;
    ...
    n.total = function(b, e, c) {
        b = b[e][c];
        c = e = 0;
        if (d.v.data.controller && d.v.data.controller.html5_disable) e += d.v.data.video.seconds;
        else for (var i = 0; i < b.length; i++) var h = b[i],
        e = e + h.seconds,
        c = c + parseInt(h.size);
        return {
            totalTime: parseInt(e),
            totalBytes: c
        }
    };
    n.processError = function(b) {
        ...
        if ( - 301 == b.error.code || -303 == b.error.code || -307 == b.error.code || -308 == b.error.code) {
            for (b = 0; b < e.length; b++) {
                ...
                e[b].drm_type = "";
                e[b].logo = "";
                e[b].milliseconds_audio = 0;
                e[b].milliseconds_video = 0;
                e[b].kye = "";
                e[b].size = 0;
                e[b].stream_fileid = "0*0";
                e[b].subtitle_lang = "";
                for (var d = 0; d < e[b].segs.length; d++) e[b].segs[d].kye = "",
                e[b].segs[d].size = 0,
                e[b].segs[d].total_milliseconds_audio = 0,
                e[b].segs[d].total_milliseconds_video = 0
            }
            return ! 1
        }
    ...
    n.init = function(b) {
        ...
        var e = b.data,
        c = e.stream;
        if (!e.security || !e.security.encrypt_string || !e.security.ip) f.sendErrorReport(2004),
        f.showError({
            code: "2004",
            message: "\u6570\u636e\u89e3\u6790\u9519\u8bef"
        },
        "\u6570\u636e\u89e3\u6790\u9519\u8bef");
        else if (!c && !e.error) f.showError({
            code: "2999",
            message: "\u6570\u636e\u89e3\u6790\u9519\u8bef"
        },
        '\u8be5\u89c6\u9891\u6682\u4e0d\u80fd\u64ad\u653e <a href="http://m.youku.com/webapp/dl?app=youku&amp;source=webqr" title="\u4e0b\u8f7d\u4f18\u9177\u5ba2\u6237\u7aef" target="_blank"><button type="button" class="x-btn" style="background: #3bb4fc;text-align: center;color: #fff;border-radius: 1rem;">\u7528app\u89c2\u770b</button></a>');
        else {
            var i = M(N(d.mk.a3 + "o0b" + f.userCache.a1, [19, 1, 4, 7, 30, 14, 28, 8, 24, 17, 6, 35, 34, 16, 9, 10, 13, 22, 32, 29, 31, 21, 18, 3, 2, 23, 25, 27, 11, 20, 5, 15, 12, 0, 33, 26]).toString(), Ea(e.security.encrypt_string));
            if (2 > i.split("_").length) f.sendErrorReport(2004),
            f.showError({
                code: "2004",
                message: "\u6570\u636e\u89e3\u6790\u9519\u8bef"
            },
            "\u6570\u636e\u89e3\u6790\u9519\u8bef");
                ...
                f.userCache.sid = i.split("_")[0];
                f.userCache.token = i.split("_")[1];
                if (null != e.error) {
                    if ( - 202 == e.error.code || -203 == e.error.code) f.sendErrorReport(4E3);
                    else {
                        if ( - 402 == e.error.code) {
                ...
                this._videoInfo = new ca(e, c, this._type);
                ...
                this._videoInfo.totalTime = h ? h.totalTime: e.video.seconds;
                ...
                this._callback(this._v, this._videoInfo);
                    ...
                    for (h = 0; h < e.length; h++) if (c.streams[i][e[h]] && !("3gphd" == e[h] && 7200 < parseInt(b.seconds))) {
                        d.defaultVideoType = e[h];
                        break
                    }
    ...
    var ca = function(b, e, d) {
        ...
        for (var h = 0; h < e.length; h++) {
            for (var q = e[h].audio_lang, g = !1, l = 0; l < d.length; l++) if (d[l] == q) {
                g = !0;
                break
            }
            g || d.push(q)
        ...
        for (h = 0; h < d.length; h++) {
            ...
            j = [], l = 0; l < e.length; l++) {
                var n = e[l];
                if (w == n.audio_lang && this.isValidType(n.stream_type)) {
                    ...
                    if (null != v) {
                        ...
                        for (t = 0; t < v.length; t++) {
                            ...
                            u.no = t;
                            u.size = s.size;
                            u.seconds = Number(s.total_milliseconds_video) / 1E3;
                            u.milliseconds_video = Number(n.milliseconds_video) / 1E3;
                            u.key = s.key;
                            u.fileId = s.fileid;
                            u.src = this.getVideoSrc(l, t, b, n.stream_type, u.fileId);
                            u.type = p;
                            r.push(u)
                        }
                        q[p] = r
    ...
    da.prototype = {
        ...
        cg_fun: function(b) {
            for (var b = b.split("*"), e = "", d = 0; d < b.length - 1; d++) e += this._cgStr.charAt(b[d]);
            return e
        },
        ran: function() {
    ...
    ca.prototype = {
        ...
        getVideoSrc: function(b, e, c, i, h, q, g) {
            var l = c.stream[b];
            ...
            w = e.toString(16);
            1 == w.length && (w = "0" + w);
            var j = l.segs[e].total_milliseconds_video / 1E3,
            e = l.segs[e].key;
            if ("" == e || -1 == e) e = l.key2 + l.key1;
            l = "";
            c.show && (l = c.show.pay ? "&ypremium=1": "&ymovie=1");
            c = "/player/getFlvPath/sid/" + f.userCache.sid + "_" + w + "/st/" + i + "/fileid/" + h + "?K=" + e + "&hd=" + b + "&myp=0&ts=" + j + "&ypp=0" + l;
            h = encodeURIComponent(K(M(N(d.mk.a4 + "poz" + f.userCache.a2, [19, 1, 4, 7, 30, 14, 28, 8, 24, 17, 6, 35, 34, 16, 9, 10, 13, 22, 32, 29, 31, 21, 18, 3, 2, 23, 25, 27, 11, 20, 5, 15, 12, 0, 33, 26]).toString(), f.userCache.sid + "_" + h + "_" + f.userCache.token)));
            c = c + ("&ep=" + h) + "&ctype=12&ev=1" + ("&token=" + f.userCache.token);
            c += "&oip=" + d.v.data.security.ip;
            return "http://k.youku.com" + (c + ((q ? "/password/" + q: "") + (g ? g: "")))
        }
    };
    var ea = function(b) {
    ...
    f.Log = function(b, e) {
        ...
        e && d.addEventListener("error", e, !1);
    ...
    f.adrInvalidPauseCheck = function(b) {
        ...
        setInterval(function() {
            b.currentTime == e && !c ? (d++, b.play(), 0 == d % 10 && (b.load(), b.play())) : c = !0
        },
        1E3)
    };
    f.sendPlayServiceQuality = function(b, e, c) {
        b = {
            n: b,
        ...
        f.Log("http://v.l.youku.com/h_player_service?" + o(b))
    };
    f.sendErrorReport = function(b) {
        var e = {},
        c = "",
        c = f.isIPAD ? "xplayer_ipad": f.isIPHONE ? "xplayer_iphone": "xplayer_android";
        e.m = c;
        e.ec = b;
        c = "";
        ...
        e.v = d.videoInfo ? d.videoInfo._sid: "";
        e.ct = d.v ? d.v.data ? d.v.data.video ? d.v.data.video.category_id: "": "": "";
        e.hd = f.hd ? f.hd: 0;
        d.v && d.v.data.network && (e.a = d.v ? d.v.data.network.area_code + "|" + d.v.data.network.dma_code: "");
        b = "";
        d.initConfig.vvlogconfig && d.initConfig.vvlogconfig.pvid && (b = d.initConfig.vvlogconfig.pvid);
        e.pid = b;
        f.Log("http://v.l.youku.com/perror?" + o(e))
    };
    f.Load = function(b, e) {
        if ("js" == e) {
            var d = document.createElement("script");
    ...
    f.showError = function(b, e) {
        ...
        c.innerHTML = e ? e: "\u8be5\u89c6\u9891\u683c\u5f0f\u7279\u6b8a\uff0c\u8bf7\u5728PC\u4e0a\u89c2\u770b";
    ...
    f.onError = function(b, e) {
        ...
        if (d.playerEvents && d.playerEvents.onPlayError) d.playerEvents.onPlayError(e ? e: "\u8be5\u89c6\u9891\u683c\u5f0f\u7279\u6b8a\uff0c\u8bf7\u5728PC\u4e0a\u89c2\u770b", b)
    }; (function() {
        ...
        if (b.canPlayType) {
            ...
            for (var c in e) f["canPlay" + c] = b.canPlayType(e[c]) ? !0 : !1
        }
        for (var h in d) if ( - 1 !== navigator.userAgent.indexOf(d[h]) ? (f[h] = !0, f.os += d[h] + " ") : f[h] = !1, -1 !== navigator.userAgent.indexOf("Android")) b = navigator.userAgent.indexOf("Android"),
        b = navigator.userAgent.substr(b, 10),
        b > d.isAndroid4 && (f.isAndroid4 = !0, f.os += b + " ");
        ...
        try {
            if (document.all) {
                ...
                if (q) {
                    var d = 1,
                    g = q.GetVariable("$version");
                    parseInt(g.split(" ")[1].split(",")[0])
                }
            } else if (navigator.plugins && 0 < navigator.plugins.length && (q = navigator.plugins["Shockwave Flash"])) for (var d = 1,
            l = q.description.split(" "), q = 0; q < l.length; ++q) isNaN(parseInt(l[q])) || parseInt(l[q])
        } catch(w) {
            h = d = 1
        }
        f.isSupportFlash = d && !h;
    ...
    R.prototype = {
        ...
        selectHandler: function() {
            ...
            if (this._events && this._events.onPlayerReady) {
                ...
                if ("h5" == f.playerType) var e = setInterval(function() {
                    if (r(f.playerId)) {
                        f.playerCurrentState = f.playerState.PLAYER_STATE_READY;
                        g.log(f.playerCurrentState);
                        clearInterval(e);
                        try {
                ...
                500);
                else "flash" == f.playerType && (e = setInterval(function() {
                    if (1 == s.swfLoaded) {
                        f.playerCurrentState = f.playerState.PLAYER_STATE_READY;
                        g.log(f.playerCurrentState);
                        clearInterval(e);
        ...
        selectH5M3U8: function() {
            ...
            var e = new YoukuHTML5Player(b, d.initConfig);
            this._h5player = e;
            n.playlistconfig = this._playlistconfig;
        ...
        processThirdParty: function(b) {
            ...
            c = this;
            e.addEventListener("openapiokyouku",
            function(e) {
                g.log("thirdparty res ok");
                c.partner_config = e.data;
                b()
            });
            e.addEventListener("openapierror",
            function() {
                g.log("thirdparty res error");
                b()
            });
            e.addEventListener("openapitimeoutyouku",
            function() {
        ...
        selectFlash: function() {
            ...
            for (var e in d.initConfig.adconfig) b[e] = d.initConfig.adconfig[e];
            for (e in d.initConfig.flashconfig) b[e] = d.initConfig.flashconfig[e];
            var c = {
                sid: this._vid,
            ...
            if ((q = d.initConfig.flashparam) && "object" == typeof q) for (h in q) b[h] = q[h];
            h = "";
            for (e in b) q = b[e],
            "object" == typeof q && (q = o(q)),
            h += "<param name=" + e + " value=" + q + ">";
    ...
    s.Player.prototype = {
        player: function() {
            return "" != this._player ? this._player: this._player = "h5" == f.playerType ? new ea(this.select._h5player) : "flash" == f.playerType ? new aa: "error"
        },
        resize: function(b, e) {
    ...
    ia.prototype = {
        onLoadedStartST: function() {
            u.log("onLoadedStartIPH");
            this._load_data = !0
        },
        onLoadedDataST: function() {
            u.log("onLoadedDataST");
            this._load_data = !1
        },
        onLoadedMetaDataST: function() {
            u.log("onLoadedMetaDataST");
            if (this.getM3U8XhrState) {
                var b = (new Date).getTime() - x.m3u8;
    ...
    K = function(b) {
        ...
        for (e = ""; d < c;) {
            ...
            if (d == c) {
                e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(h >> 2);
                e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((h & 3) << 4);
                e += "==";
                break
            }
            f = b.charCodeAt(d++);
            if (d == c) {
                e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(h >> 2);
                e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((h & 3) << 4 | (f & 240) >> 4);
            ...
            e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(h >> 2);
            e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((h & 3) << 4 | (f & 240) >> 4);
            e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt((f & 15) << 2 | (g & 192) >> 6);
            e += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(g & 63)
        }
        return e
    }; (function() {
        this.FX = function(e, d, c, m, f, g) {
            this.el = b.get(e);
            this.attributes = d;
            this.duration = c || 0.7;
        ...
        this.FX.transitions = {
            linear: function(b, e, d, c) {
                return d * b / c + e
            },
            easeIn: function(b, e, d, c) {
                return - d * Math.cos(b / c * (Math.PI / 2)) + d + e
            },
            easeOut: function(b, e, d, c) {
                return d * Math.sin(b / c * (Math.PI / 2)) + e
            },
            easeInOut: function(b, e, d, c) {
        ...
        this.FX.prototype = {
            ...
            getAttributes: function() {
                ...
                case "background-color":
                    this.startAttr[e] = d(this.attributes[e].from || b.getStyle(this.el, e));
                    this.endAttr[e] = d(this.attributes[e].to);
                    break;
                case "scrollTop":
                case "scrollLeft":
                    var c = this.el == document.body ? document.documentElement || document.body: this.el;
                    this.startAttr[e] = this.attributes[e].from || c[e];
                    this.endAttr[e] = this.attributes[e].to;
                    break;
                default:
                    var f = this.attributes[e].to,
                    g = this.attributes[e].units || "px";
                    this.attributes[e].from ? c = this.attributes[e].from: (c = parseFloat(b.getStyle(this.el, e)) || 0, "px" != g && document.defaultView && (b.setStyle(this.el, e, (f || 1) + g), c *= (f || 1) / parseFloat(b.getStyle(this.el, e)), b.setStyle(this.el, e, c + g)));
                    this.units[e] = g;
                    this.endAttr[e] = f;
                    this.startAttr[e] = c
                }
            ...
            setAttributes: function() {
                ...
                case "scrollLeft":
                case "scrollTop":
                    (this.el == document.body ? document.documentElement || document.body: this.el)[e] = this.frame[e];
                    break;
                case "color":
                case "borderColor":
                case "border-color":
        ...
        var b = {
            ...
            setStyle: function(b, d, c) {
                "opacity" == d ? (b.style.filter = "alpha(opacity=" + 100 * c + ")", b.style.opacity = c) : (d = e(d), b.style[d] = c)
            }
        },
        e = function() {
            var b = {};
            return function(e) {
                ...
                f = d.length; m < f; m++) c += d[m].charAt(0).toUpperCase() + d[m].substring(1);
                return b[e] = c
            }
        } (),
        d = function() {
            ...
            return function(c) {
                ...
                if ((m = c.match(e)) && 4 == m.length) return [parseInt(m[1] + m[1], 16), parseInt(m[2] + m[2], 16), parseInt(m[3] + m[3], 16)]
            }
        } ()
    })();
    FX.transitions.quadIn = function(b, e, d, c) {
        return d * (b /= c) * b + e
    };
    FX.transitions.quadOut = function(b, e, d, c) {
        return - d * (b /= c) * (b - 2) + e
    };
    FX.transitions.quadInOut = function(b, e, d, c) {
        return 1 > (b /= c / 2) ? d / 2 * b * b + e: -d / 2 * (--b * (b - 2) - 1) + e
    };
    FX.transitions.cubicIn = function(b, e, d, c) {
        return d * (b /= c) * b * b + e
    };
    FX.transitions.cubicOut = function(b, e, d, c) {
        return d * ((b = b / c - 1) * b * b + 1) + e
    };
    FX.transitions.cubicInOut = function(b, e, d, c) {
        return 1 > (b /= c / 2) ? d / 2 * b * b * b + e: d / 2 * ((b -= 2) * b * b + 2) + e
    };
    FX.transitions.quartIn = function(b, e, d, c) {
        return d * (b /= c) * b * b * b + e
    };
    FX.transitions.quartOut = function(b, e, d, c) {
        return - d * ((b = b / c - 1) * b * b * b - 1) + e
    };
    FX.transitions.quartInOut = function(b, e, d, c) {
        return 1 > (b /= c / 2) ? d / 2 * b * b * b * b + e: -d / 2 * ((b -= 2) * b * b * b - 2) + e
    };
    FX.transitions.quintIn = function(b, e, d, c) {
        return d * (b /= c) * b * b * b * b + e
    };
    FX.transitions.quintOut = function(b, e, d, c) {
        return d * ((b = b / c - 1) * b * b * b * b + 1) + e
    };
    FX.transitions.quintInOut = function(b, e, d, c) {
        return 1 > (b /= c / 2) ? d / 2 * b * b * b * b * b + e: d / 2 * ((b -= 2) * b * b * b * b + 2) + e
    };
    FX.transitions.expoIn = function(b, e, d, c) {
        return 0 == b ? e: d * Math.pow(2, 10 * (b / c - 1)) + e - 0.0010 * d
    };
    FX.transitions.expoOut = function(b, e, d, c) {
        return b == c ? e + d: 1.001 * d * ( - Math.pow(2, -10 * b / c) + 1) + e
    };
    FX.transitions.expoInOut = function(b, e, d, c) {
        return 0 == b ? e: b == c ? e + d: 1 > (b /= c / 2) ? d / 2 * Math.pow(2, 10 * (b - 1)) + e - 5.0E-4 * d: 1.0005 * (d / 2) * ( - Math.pow(2, -10 * --b) + 2) + e
    };
    FX.transitions.circIn = function(b, e, d, c) {
        return - d * (Math.sqrt(1 - (b /= c) * b) - 1) + e
    };
    FX.transitions.circOut = function(b, e, d, c) {
        return d * Math.sqrt(1 - (b = b / c - 1) * b) + e
    };
    FX.transitions.circInOut = function(b, e, d, c) {
        return 1 > (b /= c / 2) ? -d / 2 * (Math.sqrt(1 - b * b) - 1) + e: d / 2 * (Math.sqrt(1 - (b -= 2) * b) + 1) + e
    };
    FX.transitions.backIn = function(b, e, d, c, h) {
        h = h || 1.70158;
        return d * (b /= c) * b * ((h + 1) * b - h) + e
    };
    FX.transitions.backOut = function(b, e, d, c, h) {
        h = h || 1.70158;
        return d * ((b = b / c - 1) * b * ((h + 1) * b + h) + 1) + e
    };
    FX.transitions.backBoth = function(b, e, d, c, h) {
        h = h || 1.70158;
        return 1 > (b /= c / 2) ? d / 2 * b * b * (((h *= 1.525) + 1) * b - h) + e: d / 2 * ((b -= 2) * b * (((h *= 1.525) + 1) * b + h) + 2) + e
    };
    FX.transitions.elasticIn = function(b, e, d, c, h, f) {
        if (0 == b) return e;
        if (1 == (b /= c)) return e + d;
        f || (f = 0.3 * c); ! h || h < Math.abs(d) ? (h = d, d = f / 4) : d = f / (2 * Math.PI) * Math.asin(d / h);
        return - (h * Math.pow(2, 10 * (b -= 1)) * Math.sin((b * c - d) * 2 * Math.PI / f)) + e
    };
    FX.transitions.elasticOut = function(b, e, d, c, h, f) {
        if (0 == b) return e;
        if (1 == (b /= c)) return e + d;
        f || (f = 0.3 * c);
        if (!h || h < Math.abs(d)) var h = d,
        g = f / 4;
        else g = f / (2 * Math.PI) * Math.asin(d / h);
        return h * Math.pow(2, -10 * b) * Math.sin((b * c - g) * 2 * Math.PI / f) + d + e
    };
    FX.transitions.elasticBoth = function(b, e, d, c, h, f) {
        if (0 == b) return e;
        ...
        return 1 > b ? -0.5 * h * Math.pow(2, 10 * (b -= 1)) * Math.sin((b * c - g) * 2 * Math.PI / f) + e: 0.5 * h * Math.pow(2, -10 * (b -= 1)) * Math.sin((b * c - g) * 2 * Math.PI / f) + d + e
    };
    FX.transitions.backIn = function(b, e, d, c, h) {
    ...
    FX.transitions.bounceIn = function(b, e, d, c) {
        return d - FX.transitions.bounceOut(c - b, 0, d, c) + e
    };
    FX.transitions.bounceOut = function(b, e, d, c) {
    ...
    FX.transitions.bounceBoth = function(b, e, d, c) {
        return b < c / 2 ? 0.5 * FX.transitions.bounceIn(2 * b, 0, d, c) + e: 0.5 * FX.transitions.bounceOut(2 * b - c, 0, d, c) + 0.5 * d + e
    }; (function(b) {
        function e(b, e) {
        ...
        b.jsonp = function(b) {
            ...
            f = b.data || {},
            X = parseInt(b.time) || 1E4,
            l = "cb_" + Y(6);
            f[c] = "YKU.callback." + l;
            var c = o(f),
            f = b.url,
            f = -1 === f.indexOf("?") ? f + ("?" + c) : f + ("&" + c),
            j = document.createElement("script");
            d[l] = function(e) {
                try {
                    "timeout" != j.jsonp && (j.jsonp = "success", b.success && b.success(e))
                } catch(d) {
                    g.log("-- JSONP --"),
                    g.log(d)
                }
            };
            X && (j.timer = setTimeout(function() {
                j.jsonp = "timeout";
                b.fail && b.fail({
                    message: "timeout"
                })
            ...
            j.onreadystatechange = j.onload = function() {
                if (!this.readyState || this.readyState == "loaded" || this.readyState == "complete") {
                    j.jsonp !== "timeout" && j.jsonp != "success" && b.fail && b.fail({
                        message: "fail"
                    });
                    e(j, l)
                }
    ...
    var ja = function() {};
    ja.prototype = {
        cookie: function(b, e, d, c) {
            "string" == typeof b && (c = d, d = e, e = b, b = window);
            if (void 0 !== d) {
                var c = c || {},
                h;
                h = "";
                ...
                c = c.secure ? "; secure": "";
                b.document.cookie = [e, "=", encodeURIComponent(d), h, f, g, c].join("")
            } else return (d = b.document.cookie.match(RegExp("(?:\\s|^)" + e + "\\=([^;]*)"))) ? decodeURIComponent(d[1]) : null
        },
        pvid: function() {
        ...
        Mash: function() {
            var b = 4022871197,
            e = function(e) {
                for (var e = e.toString(), d = 0; d < e.length; d++) {
                    b += e.charCodeAt(d);
        ...
        MRG32k3a: function() {
            ...
            return function(e) {
                ...
                for (var j = b.Mash(), n = 0; n < e.length; n++) d += 4294967296 * j(e[n]),
                c += 4294967296 * j(e[n]),
                h += 4294967296 * j(e[n]),
                f += 4294967296 * j(e[n]),
                g += 4294967296 * j(e[n]),
                ...
                o = function() {
                    ...
                    c = h;
                    h = b;
                    e = 527612 * l - 1370589 * f;
                    e -= 4294944443 * (e / 4294944443 | 0);
                    0 > e && (e += 4294944443);
                    f = g;
                    g = l;
                    l = e;
                    return b <= e ? b - e + 4294967087 : b - e
                },
                p = function() {
                    return 2.3283064365386963E-10 * o()
                };
                p.uint32 = o;
                p.fract53 = function() {
                    return p() + 1.1102230246251565E-16 * (o() & 2097151)
                };
        ...
        rand: function(b, e) {
            ...
            return e + ( + new Date).toString(32) + parseInt(1E5 * d()).toString(32)
        },
        seid: function() {
            ...
            var e = this.cookie("referhost");
            if (!e || +new Date > (parseInt(this.cookie("seidtimeout")) || 0)) e = (e = /^https?:\/\/[^\/]+/.exec(document.referrer || "")) ? e[0] : "",
            this.cookie("referhost", e, {
                domain: "youku.com",
                path: "/"
            });
    ...
    S.prototype = {
        init: function(b) {
            if (b && (b.data && b.data && b.data.error) && (d.hide(d.get(".x-video-button")), d.hide(d.get(".x-console")), this._vid = b.data.id, this._title = b.data.video.title, this._userid = b.data.video.userid, this._error = b.data.error, this._errorcode = parseInt(b.data.error.code), !( - 301 == this._errorcode || -307 == this._errorcode || -308 == this._errorcode))) {
                ...
                case - 100 : this.setMessage(L["-100"]);
                    f.onError({
                        code: "1000",
                        message: "\u89c6\u9891\u8f6c\u7801\u4e2d"
                    },
                    "\u89c6\u9891\u8f6c\u7801\u4e2d");
                    break;
                case - 101 : this.setMessage(L["-101"]);
                    f.onError({
                        code: "1000",
                        message: "\u89c6\u9891\u5ba1\u6838\u4e2d"
                    },
                    "\u89c6\u9891\u5ba1\u6838\u4e2d");
                    break;
                case - 102 : this.setMessage(L["-102"]);
                    ...
                    "\u89c6\u9891\u5df2\u88ab\u5c4f\u853d");
                    break;
                case - 103 : this.setMessage(L["-103"]);
                    ...
                    "\u89c6\u9891\u8f6c\u7801\u5931\u8d25");
                    break;
                case - 201 : this.setMessage(L["-201"]);
        ...
        inputPassword: function() {
            ...
            e = b.value;
            if (null == e || 0 == e.replace(/\s/g, "").length) b.value = "",
            b.placeholder = "\u5bc6\u7801\u4e3a\u7a7a\uff0c\u8bf7\u91cd\u65b0\u8f93\u5165";
            else {
                var c = this.player;
                d.password = e;
                n.start(this._vid, e, d.config.content,
                function(b, f) {
    ...
    ka.prototype = {
        ...
        switchFullScreen: function(b) {
            ...
            d.config.events && d.config.events.onSwitchFullScreen ? ( - 1 === c.indexOf("in") ? (this._fullflag = !1, this._btnb.className = c.replace(/out/g, "in"), this.player.controls.hideShowListBtn(), this.player._reporter.sendUserActionReport("xexfs", e), this.player.adjustVideoRatio(1), this.dispatch({
                type: "exitfullscreen"
            })) : (this._fullflag = !0, this._btnb.className = c.replace(/in/g, "out"), this.player.controls.showShowListBtn(), this.player._reporter.sendUserActionReport("xenfs", e), this.player.adjustVideoRatio(), this.dispatch({
                type: "enterfullscreen"
            })), e = d.config.events.onSwitchFullScreen, e(b, c)) : (b = document.getElementById("x-player"), -1 === c.indexOf("in") ? (this.player._reporter.sendUserActionReport("xexfs", e), document.webkitCancelFullScreen && (this._btnb.className = c.replace(/out/g, "in"), this._fullflag = !1, document.webkitCancelFullScreen())) : (this.player._reporter.sendUserActionReport("xenfs", e), b.webkitRequestFullScreen ? (this._btnb.className = c.replace(/in/g, "out"), this._fullflag = !0, b.webkitRequestFullScreen()) : this.player.video.webkitSupportsFullscreen && 1 <= this.player.video.readyState && this.player.video.webkitEnterFullscreen()))
        }
    };
    var la = function(b, e) {
        this.handler = {};
    ...
    ma.prototype = {
        ...
        setTip: function(b, e) {
            ...
            this._time.innerHTML = d.getTime(Ga(b + e));
            0 >= e ? (d.show(this._back), d.hide(this._forward)) : (d.show(this._forward), d.hide(this._back));
            var c = this;
            setTimeout(function() {
    ...
    var na = function(b, e) {
        ...
        if (d.isWeixin) d.get(".x-localization").style.display = "none";
        else if (!e || !e.data || !e.data || !e.data.dvd || !e.data.dvd.audiolang) d.get(".x-localization").style.display = "none";
        else {
            if (d.videoInfo._videoSegsDic) {
                ...
                for (g in i) {
                    c = "";
                    for (k in i[g]) c += k + ","; (c = -1 < c.indexOf("3gphd") || -1 < c.indexOf("mp4") ? !1 : !0) && (f = !0)
                }
                if (c && f) {
    ...
    na.prototype = {
        ...
        init: function(b) {
            for (var b = b.data,
            e = b.dvd.audiolang,
            d = ["<button class=x-control-btn>", "", "</button>"], c = ["<div class=x-panel><ul>", "", "</ul><div class=x-mask></div>", "</div>"], f = [], g = 0; g < e.length; g++) {
                var j = "",
                j = j + ("<li data-vid=" + e[g].vid),
                j = j + (" data-language=" + e[g].lang),
                j = j + (" data-language-code=" + e[g].langcode);
                e[g].vid == b.video.encodeid ? (d[1] = e[g].lang, j += " class=selected>") : j += ">";
                j += e[g].lang + "</li>";
                f[g] = j
            }
            c[1] = f.join("");
        ...
        bindEvent: function() {
            ...
            if (0 != b.length) {
                ...
                for (var e = 0; e < b.length; e++) d.addEventHandler(b[e], "click", d.bindAsEventListener(this, this.switchLanguage))
            }
        },
        removeEvent: function() {
        ...
        toggleLanguagePanel: function(b) {
            var e = this._panel; - 1 === this._language.className.indexOf("pressed") ? (this._language.className += " pressed", e.style.display = "block", this.dispatch({
                type: "settingshow"
        ...
        switchLanguage: function(b) {
            ...
            i = 0; i < c.length; i++) if (c[i].getAttribute("data-vid") == e) {
            ...
            if (null != d.videoInfo._videoSegsDic && null != d.videoInfo._videoSegsDic.streams[b]) {
                ...
                f.video.src = d.m3u8src_v2(e, d.defaultVideoType);
                else {
                    e = d.videoInfo._videoSegsDic.streams[b];
                    if (e[d.defaultVideoType]) d.defaultLanguage = b;
                    else {
                        c = ["3gphd", "mp4"];
                        for (i = 0; i < c.length; i++) if (e[c[i]]) {
                            d.defaultVideoType = c[i];
                            d.defaultLanguage = b;
                            break
                        }
                    }
                    f.video.src = d.videoInfo._videoSegsDic.streams[d.defaultLanguage][d.defaultVideoType][0].src
                }
                f.video.load();
                f.video.play()
            }
    ...
    oa.prototype = {
        ...
        setProgress: function(b, e) {
            ...
            this._play.style.width = 100 * i + "%"; ! 0 !== e && (this.loadTime = c += Math.max(this.player.bufferedEnd() - b, 0), i = c / d.videoInfo.totalTime + 0.05, this._load.style.width = 100 * Math.min(Math.max(i, 0), 1) + "%")
        },
    ...
    pa.prototype = {
        ...
        init: function(b) {
            ...
            if (b.data.trial && f.type && "episodes" != b.data.trial.type) {
                f = f.type.join(",") + ",";
                if (! (0 <= f.indexOf("fee,"))) if (0 <= f.indexOf("channel_vip,")) c = !1;
                else return;
        ...
        processData: function(b, e) {
            ...
            i = e.data.video.title;
            12 < i.length && (i = i.substr(0, 12) + "...");
            c = " " + c.replace(/<[^(<||>)]{0,}>/g,
            function(b) {
                var d = b.indexOf("<"),
                e = b.indexOf(">");
                return b.substring(0, d) + " <span class=x-vip>" + b.substring(d + 1, e) + "</span> " + b.substring(e + 1) + " "
            });
        ...
        play: function() {
            if ((f.isIPHONE || f.isIPOD) && null != d.v.data.trial) this.player.video.style.display = "block";
    ...
    var qa = function(b, e, c) {
        ...
        var e = parseInt(d.videoInfo.totalTime, 10),
        ...
        d.videoInfo.totalTime = e > this._limitTime ? this._limitTime: e;
    ...
    qa.prototype = {
        create: function() {
            ...
            if (!this._isCreated) {
                var e;
                e = 99 == this.cateId && this.needOpen ? "x-app-guide-5min": 600 == d.videoInfo.totalTime ? "x-app-guide": "x-app-guide-other";
                this._isLimit && (this.xplayer.appendChild(this._createTemplate("x-app-bg", "&nbsp;")), this.xplayer.appendChild(this._createTemplate(e, '<div class="x-app-guide-par"><p class="x-btn-closep">&nbsp;</p><div class="x-app-openapp"></div></div>')), this._content = d.get("." + e), this._bg = document.querySelectorAll(".x-app-bg")[0], this._closeBtn = this._content.getElementsByClassName("x-btn-closep")[0], this._downloadBtn = this._content.getElementsByClassName("x-app-openapp")[0], this._closeBtn.addEventListener("touchend",
                function() {
                    b.limitAppHide()
                },
        ...
        limitAppEnd: function() {
            if (this._isLimit && this._content) {
                ...
                for (var b = "x-video-logo x-video-loading x-video-info x-video-button x-feedback x-pay x-pay-panel x-advert x-ad-pause x-prompt x-dashboard x-showlist x-tips x-trigger".split(" "), d = 0, c = b.length; d < c; d++) {
                    var f = document.querySelectorAll("." + b[d]);
        ...
        getYoukuAppSchema: function(b, d) {
            var c, f = [];
            d ? c = "http://iosport.youku.com/ipad/ulink?": (c = "youku://", "ipad" == b.client ? c = "youkuhd://": "isAndroidChrome" == b.client && (c = "intent://"), c += "play?");
            f.push("vid=" + b.id);
            f.push("pid=" + b.pid);
            f.push("guid=" + b.guid);
            f.push("idfa=" + b.idfa);
        ...
        openApp: function() {
            ...
            this.YoukuAppSchema = this.getYoukuAppSchema({
                ...
                client: f.isIPAD && "ipad" || -1 != b.indexOf("Android") && -1 < b.indexOf("Chrome") && null == b.match(/Chrome\/\d+\.0\.0\.0/i) && "androidChrome",
    ...
    ra = function(b, e) {
        this._handler = {}; ! d.isWeixin && f.isIPAD7 && (this.player = b, this.playRate = d.get(".x-playspeed"), this.init(e), this.bindEvent(), this.button = this.playRate.getElementsByTagName("button")[0], this.panel = this.playRate.getElementsByTagName("div")[0], this.nodes = this.playRate.getElementsByTagName("li"), d.show(this.playRate))
    };
    ra.prototype = {
        ...
        init: function() {
            for (var b = ["<button class=x-control-btn>", "", "</button>"], d = ['<div class=x-panel style="display:none"><ul>', "", "</ul><div class=x-mask></div>", "</div>"], c = "", f = [], h = ["2", "1.5", "1", "0.8"], g = 0; g < h.length; g++) {
                var j = h[g],
                l = "",
                n = "";
                "1" == j && (l = "", b[1] = H[j], n = " class=selected");
                c += "<li data-vtype=" + j + n + ">" + l + H[j] + "</li>";
                f.push(H[j])
            }
            d[1] = c;
        ...
        bindEvent: function() {
            ...
            if (0 != b.length) {
                ...
                for (var e = 0; e < b.length; e++) d.addEventHandler(b[e], "click", d.bindAsEventListener(this, this.switchRate))
            }
        },
        removeEvent: function() {
        ...
        switchRate: function(b) {
            ...
            c = this.nodes,
            f = 0; f < c.length; f++) if (c[f].getAttribute("data-vtype") == b) {
                if ( - 1 !== c[f].className.indexOf("selected")) {
                    this.toggleRatePanel();
                    return
                }
                c[f].innerHTML = H[b];
                c[f].className += " selected";
                d.innerHTML = H[b]
            } else {
                var h = c[f].getAttribute("data-vtype");
                c[f].innerHTML = H[h];
                c[f].className = c[f].className.replace(/selected/, "")
            }
            this.toggleRatePanel();
            this.dispatch({
                type: "settingdone"
    ...
    sa.prototype = {
        ...
        setProgress: function(b, e) {
            ...
            this.playTime = c;
            var f = c / d.videoInfo.totalTime,
            h = this._track.offsetWidth,
            g = this._seek.offsetWidth;
            this._play.style.width = Math.min(100 * (f + g / h / 2), 100) + "%";
            this._seek.style.left = f * h > h - g ? h - g + "px": 100 * Math.min(Math.max(f, 0), 1) + "%";
            this.uCurrentTime.innerHTML = d.getTime(c); ! 0 !== e && (this.loadTime = c += Math.max(this.player.bufferedEnd() - b, 0), f = c / d.videoInfo.totalTime, this._load.style.width = 100 * Math.min(Math.max(f + 0.05, 0), 1) + "%")
        },
        resetProgress: function() {
        ...
        getRate: function(b, e) {
            var c = 1,
            f = d.get(".x-fs-console");
            f && (c = parseFloat(d.getCurrentStyle(f).zoom));
            return b / (e * c)
        },
        seek: function(b) {
            var e = (new Date).getTime() - ta;
            if (b.srcElement == this._seek || e < ua) return g.log(e + "," + ua),
            !1;
            this.player._reporter.sendUserActionReport("xcs", "c");
            e = b.offsetX || b.changedTouches[0].clientX - this._track.clientX;
            g.log("x = " + e);
            var e = this.getRate(e, this._track.offsetWidth),
            c = e * d.videoInfo.totalTime;
            g.log("progress bar time = " + c + "rate = " + e + "total = " + d.videoInfo.totalTime);
        ...
        onTouchStart: function(b) {
            ...
            if ("mp4" == d.config.content) {
                ...
                for (b = 0; b < y; b++) this.startTime += parseInt(d.videoInfo._videoSegsDic.streams[d.defaultLanguage][d.defaultVideoType][b].seconds)
            }
    ...
    var va = function(b, e) {
        ...
        "m3u8" != d.config.content ? d.get(".x-quality").style.display = "none": !e || !e.data || !e.data.stream[0] || !e.data.stream[0].stream_type ? d.get(".x-quality").style.display = "none": (this.player = b, this._quality = d.get(".x-quality"), this.init(e), this.bindEvent(), this._button = this._quality.getElementsByTagName("button")[0], this._panel = this._quality.getElementsByTagName("div")[0], this._nodes = this._quality.getElementsByTagName("li"))
    };
    va.prototype = {
        addEventListener: function(b, d) {
            this._handler[b] = d
        ...
        init: function() {
            ...
            e = ["<button class=x-control-btn title=\u753b\u8d28\u8bbe\u7f6e>", "", "</button>"],
            c = ['<div class=x-panel style="display:none"><ul>', "", "</ul><div class=x-mask></div>", "</div>"],
            f = "",
            h = [],
            g;
            for (g in B) if ( - 1 !== b[d.defaultLanguage].indexOf(g) && -1 === h.indexOf(B[g])) {
                var j = "",
                l = "";
                g == d.defaultVideoType && (j = "", e[1] = B[g], l = " class=selected");
                f += "<li data-vtype=" + g + l + ">" + j + B[g] + "</li>";
                h.push(B[g])
            }
            "" == e[1] && (e[1] = h[0]);
            c[1] = f;
            this._quality.innerHTML = e.join("") + c.join("")
        },
        bindEvent: function() {
            ...
            if (0 != b.length) {
                ...
                for (var e = 0; e < b.length; e++) d.addEventHandler(b[e], "click", d.bindAsEventListener(this, this.switchQuality))
            }
        },
        removeEvent: function() {
        ...
        switchQuality: function(b) {
            ...
            for (var c = b.target,
            b = null,
            b = c.getAttribute ? c.getAttribute("data-vtype") : c.parentNode.getAttribute("data-vtype"), c = this._button, f = this._nodes, i = 0; i < f.length; i++) if (f[i].getAttribute("data-vtype") == b) {
                if ( - 1 !== f[i].className.indexOf("selected")) {
                ...
                var h = f[i].getAttribute("data-vtype");
                f[i].innerHTML = B[h];
                f[i].className = f[i].className.replace(/selected/, "")
            }
            g.log("q1");
            this.toggleQualityPanel();
            this.dispatch({
            ...
            var q = this.player.currentTime,
            n = d.m3u8src_v2(d.v.data.id, b);
            d.unitedTag = null;
            ...
            function() {
                1 === o ? g.log("XXXXXXXXXXXXXXXXXXXXX") : (o = 1, g.log("q2 nsrc=" + n), l.player.seek(q), g.log("q3"))
            });
    ...
    wa.prototype = {
        ...
        request: function(b) {
            ...
            c.pl = 36;
            for (var f in d.initConfig.playlistconfig) c[f] = d.initConfig.playlistconfig[f];
            var i = this;
            s.jsonp({
                url: "http://ykrec.youku.com/video/packed/list.json?",
                data: c,
                success: function(b) {
                    i.parseResponse(b)
                },
        ...
        buildPanel: function(b) {
            ...
            g.log("realted len = " + c);
            var f = [];
            f.push('<ul class="x-item" data-i="x"><li class="x-item-img"><img src="http://player.youku.com/h5player/img/replay.png"></li></ul>');
            for (var i = Math.floor((this._panel.offsetWidth - 60 + 16) / 166) * Math.floor((this._panel.offsetHeight - 120 + 12) / 97), i = (i > c ? c: i) - 1, i = 0 > i ? 0 : i, c = 0; c < i; c++) {
                var h = b[c].picUrl,
                j = b[c].title.substr(0, 20),
                n = "http://v.youku.com/v_show/id_" + b[c].codeId + ".html?from=",
                l = "y7",
                ...
                n = n + l;
                g.log(n);
                "myoukucom" == d.initConfig.client_id && (n = "http://m.youku.com/smartphone/detail?vid=" + b[c].codeId);
                f.push('<ul class="x-item" data-i=' + c + '><li class="x-item-img"><img src=' + h + '></li><li class="x-item-info"><div class="x-item-title">' + j + '</div><div class="x-item-bg"></div></li><li class="x-item-url"><a href=' + n + ' target="_blank"></a></li><li class="x-item-loading"><div class="x-play-loading"></div></li></ul>')
            }
            this._listinner.innerHTML = f.join("");
    ...
    xa.prototype = {
        init: function(b) {
            ...
            if (b.data.videos) {
                ...
                f = ["<ul class=x-showlist-bullet>", "", "</ul>"], i = [], h = 0; h < c.length; h++) {
                    var g = c[h],
                    j = "http://v.youku.com/v_show/id_" + g.encodevid + ".html";
                    d.v.folder && (j = j + "?f=" + d.v.folder.folderId);
                    var l = "";
                    g.encodevid == d.v.data.video.encodeid && (l = " class=selected");
                    g = "<li" + l + "><a touchstart=\"this.parentNode.className='selected'\" href=" + j + ">" + g.title.substr(0, 20) + "</a></li>";
                    i.push(g)
                }
                f[1] = i.join("");
                this._slbd.innerHTML = f.join("");
                f = "<div class=x-showlist-pages>;<span class=x-showlist-pre></span>;<ul>;;</ul>;<span class=x-showlist-next></span>".split(";");
                i = [];
    ...
    T = function(b, d, c) {
        ...
        f.hd = this.getHDFlag();
        if (0 < J.length) for (b = 0; b < J.length; b++) this.sendUepReport(J[b].type, J[b].time);
        this.dimension = {
    ...
    T.prototype = {
        sendRecommendLog: function(b) {
            f.Log("http://r.l.youku.com/recclick?" + o(b))
        },
        tsInit: function() {
            this.tsSn = null
        },
        sendTSLog: function(b) {
            ...
            if (0 == this.tsSn) this.tsSn++;
                ...
                f.Log("http://p-log.ykimg.com/tslog?" + o(h));
                f.Log("http://yt.mmstat.com/yt/vp.vtslog?" + o(h))
            }
        },
        signTS: function(b) {
            if (null == b) return 0;
            for (var d = 0,
            c = b.length,
            f = 0; f < c; f++) d = 43 * d + b.charCodeAt(f),
            d %= 1E10;
            return d
        },
        ...
        getHDFlag: function() {
            ...
            for (var f in b) if ( - 1 !== c.indexOf(f)) return b[f];
            return 0
        },
        ...
        addClientDurationReport: function(b) {
            ...
            if (0 != this.tsSn) {
                ...
                h.uid = d.v.data.user.uid;
                h.r = this.signTS(h.vvid + h.vid + h.cpt + h.pt + h.sn);
                f.Log("http://p-log.ykimg.com/acfunts?" + o(h))
            }
        },
        countBuffered: function() {
            ...
            try {
                ...
                d = this.player.video.buffered.end(b - 1),
                alert(d)
            } catch(c) {
                d = this.player.currentTime ? Math.floor(this.player.currentTime) : 0
            }
            return d
        },
        addPlayerDurationReport: function(b) {
            ...
            if (! (null == c || null == c._playListData)) {
                ...
                f.Log("http://stat.youku.com/player/addPlayerDurationReport?" + o(i));
                delete i.pvid;
                window.UrchinAplus && window.UrchinAplus._yVvlogInfo ? (b = window.UrchinAplus._yVvlogInfo(), f.Log("http://yt.mmstat.com/yt/vp.vdoview?" + o(i) + "&" + o(b))) : f.Log("http://yt.mmstat.com/yt/vp.vdoview?" + o(i))
            }
        },
        ...
        sendUserActionReport: function(b, c, m) {
            ...
            c.x = K(o(i));
            m = o(c);
            if ("xre" == b) this.checkPlayerResize("http://e.stat.ykimg.com/red/ytes.php?", m);
            else {
                if ("xenfs" == b || "xexfs" == b) {
                    this._giveupReTag = !0;
                    var g = this;
                ...
                c.jurl = "";
                f.Log("http://yt.mmstat.com/yt/vp.event?" + o(c));
                f.Log("http://p-log.ykimg.com/event?" + m)
            }
        },
                ...
                setTimeout(function() {
                    if (0 != i._resizeList.length) {
                        for (var c = i._resizeList[0].time, d = 0; d < i._resizeList.length; d++) {
                            var e = i._resizeList[d].w,
                            m = i._resizeList[d].h,
                            g = i._resizeList[d].time;
                            if (e != i.dimension.w || m != i.dimension.h) i.dimension.w = e,
                            i.dimension.h = m,
                            (800 < g - c || d == i._resizeList.length - 1) && f.Log(b + i._resizeList[d].str)
                        }
                        i._resizeList = []
                    }
                },
        ...
        cookie: function(b, c, d, f) {
            "string" == typeof b && (f = d, d = c, c = b, b = window);
            if (void 0 !== d) {
                var f = f || {},
                h;
                h = "";
                f.expires && (f.expires.constructor == Date ? h = f.expires: (h = new Date, h.setTime(h.getTime() + 864E5 * f.expires)), h = "; expires=" + h.toGMTString());
                var g = f.path ? "; path=" + f.path: "",
                j = f.domain ? "; domain=" + f.domain: "",
                f = f.secure ? "; secure": "";
                b.document.cookie = [c, "=", encodeURIComponent(d), h, g, j, f].join("")
            } else return (d = b.document.cookie.match(RegExp("(?:\\s|^)" + c + "\\=([^;]*)"))) ? decodeURIComponent(d[1]) : null
        },
        sendUepReport: function(b, c, m) { ! 1 !== m && 10 < 100 * Math.random() || (m = "", m = f.isIPAD ? "xplayer_ipad": f.isIPHONE ? "xplayer_iphone": "xplayer_android", b = {
                m: m,
                hd: this.getHDFlag(),
                t: b,
                s: c,
            ...
            f.Log("http://v.l.youku.com/uep?" + o(b)))
        },
        ...
        sendComScoreReport: function(b) {
            if (!this._hasComScore) {
                for (var c = document.getElementsByTagName("script"), f = 0; f < c.length; f++) if ( - 1 !== c[f].src.indexOf("scorecardresearch.com/beacon.js")) {
                    this._hasComScore = !0;
                    break
                } ! 0 !== this._hasComScore && (c = document.createElement("script"), f = document.getElementsByTagName("script")[0], c.async = !0, c.src = ("https:" == document.location.protocol ? "https://sb": "http://b") + ".scorecardresearch.com/beacon.js", f.parentNode.insertBefore(c, f));
                this._hasComScore = !0
            }
        ...
        sendClientConsumeReport: function() { ! 0 != this.isSendedConsumeReport && (null != d.config.partner_config && 1 == d.config.partner_config.status && null != d.config.partner_config.token && "" != d.config.partner_config.token) && (this.isSendedConsumeReport = !0, f.Log("https://api.youku.com/players/consume.json?token=" + d.config.partner_config.token))
        },
    ...
    var za = function(b, c) {
        ...
        2 != this.info.VAL[0].VT && (this.init(), this.bindEvent(), this._adreporter = new O(this, c.data));
        this.loadVC()
    };
    za.prototype = {
        ...
        adjustIMGWH: function() {
            ...
            c = this.info.VAL[0].H,
            f = (d.get("#x-player").offsetHeight - 110) / c;
            if (1 < f || 0 >= f) f = 1;
            this.info.VAL[0].W = b * f;
            this.info.VAL[0].H = c * f;
        ...
        loadVC: function() { (2 == this.info.VAL[0].VT || 1 == this.info.VAL[0].VT) && E(this.info.VAL[0].VC, "js")
        }
    };
    var Aa = function(b, c) {
        this._handler = {};
    ...
    Aa.prototype = {
        ...
        buildAdRS: function() {
            for (var b = "http://pl-ali.youku.com/playlist/m3u8?",
            c = {},
            m = {},
            i = this._adinfo.VAL,
            h = 0; h < i.length; h++) {
            ...
            m.push(d.v.data.id);
            i = encodeURIComponent(K(M(N(d.mk.a4 + "poz" + f.userCache.a2, [19, 1, 4, 7, 30, 14, 28, 8, 24, 17, 6, 35, 34, 16, 9, 10, 13, 22, 32, 29, 31, 21, 18, 3, 2, 23, 25, 27, 11, 20, 5, 15, 12, 0, 33, 26]).toString(), f.userCache.sid + "_" + m.join("") + "_" + f.userCache.token)));
            c.ep = i;
            c.sid = f.userCache.sid;
            c.token = f.userCache.token;
            c.ctype = "12";
            c.ev = "1";
            c.oip = d.v.data.security.ip;
            return b += o(C(c, d.getUCParam(d.v.data.id)))
        },
        run: function() {
            if (! (null == this._adinfo || null == this._adinfo.VAL || 0 == this._adinfo.VAL.length)) {
                ...
                c = 0, d = 0; d < this._adinfo.VAL.length; d++) {
                    ...
                    if (! (null == f.VID || null == f.VQT)) {
                        ...
                        null == f.SUE && (f.SUE = []);
                        if (0 == d) b.SUS = f.SUS || [];
                        else for (var h = 0; h < f.SUS.length; h++) b.SU.push({
                            T: c,
                            U: f.SUS[h].U
                        });
                        for (h = 0; h < f.SU.length; h++) {
                            var g = f.SU[h].T + c;
                            b.SU.push({
                                T: g,
                                U: f.SU[h].U
                        ...
                        if (d == this._adinfo.VAL.length - 1) b.SUE = f.SUE;
                        else for (h = 0; h < f.SUE.length; h++) g = c + f.AL,
                        b.SU.push({
                            T: g,
                            U: f.SUE[h].U
                        });
                        ...
                        if (0 != this._vt2nodes.length) for (h = 0; h < this._vt2nodes.length; h++) f = this._vt2nodes[h].VC,
    ...
    var U = function(b, c) {
        ...
        this._playTag = [];
        this.bindAdEvent();
        this._adreporter = new O(this, this._addata)
    };
    U.prototype = {
        addEventListener: function(b, c) {
            this._handler[b] = c
    ...
    D = "adend";
    A = "aderror";
    Q = "frontAdinfoadapterok";
    I = void 0;
    var V = function(b, c, f) {
        this._handler = {};
        this.player = b;
        this.sid = f;
        this._advids = [];
    ...
    V.prototype = {
        ...
        initRequestParam_: function(b) {
            ...
            for (var f in d.initConfig.adconfig) c[f] = d.initConfig.adconfig[f];
            this._param = c
        },
        bindEvent: function() {
            var b = this;
        ...
        frontAd: function() {
            ...
            s.jsonp({
                ...
                time: 8E3,
                success: function(c) {
                    f.isIPAD ? (g.log("<font color=red> new m3u8 api</font>"), d.OLD_M3U8 = !1, b.adParseUnited(c)) : b.adParse(c)
                },
                fail: function() {
    ...
    O.prototype = {
        ...
        sendUnitedVTVC: function(b) {
            ...
            null != d && -1 == this._vtccache.indexOf(f) && (this._vtccache.push(f), g.log("<b> vc = " + d + "</b>"), E(d, "js"))
        },
        sendVC: function() {
            var b = this.addata.info.VAL[this.addata.curnum];
            "undefined" != typeof b.VT && E(b.VC, "js")
        },
        sendSUS_: function() {
    ...
    ha.prototype = {
        buildDirectDom: function(b) {
            b.innerHTML = "<div id=x-player class=" + F(d.config.width) + '><div class="x-video-poster"><img id="x-img"/></div><div class="x-video-button"><div class="x-video-play-ico"></div></div><div class="x-video-info"><h1 class="x-title"></h1><div class="x-video-state" style="display:none"><span class="x-time-span"></span></div><div class="x-showmore"></div><div class="x-mask"></div></div>'
        },
        bindEvent: function() {
        ...
        startPlay: function(b, c) {
            ...
            this._reporter = new T(this, d.v, d.videoInfo._sid);
            this.bindEvent()
        },
        onPlayStart: function() {
            f.playerCurrentState = f.playerState.PLAYER_STATE_PLAYING;
            d.config.events && d.config.events.onPlayStart && (g.log(f.playerCurrentState), g.log("api:onplaystart"), d.config.events.onPlayStart())
        },
        getSrc: function() {
        ...
        b.getCurrAbsPath = function() {
            ...
            f = d.length - 1,
            g; g = d[f--];) if ("interactive" === g.readyState) return b ? g.getAttribute("src", 4) : g.src
        }
    })(window);
    var ga = /(http|https|file):\/\/.[a-zA-Z0-9][-a-zA-Z0-9]{0,62}(\.[a-zA-Z0-9][-a-zA-Z0-9]{0,62})+\.?/.exec(getCurrAbsPath())[0];
    E(ga + "/h5player/play.css?ver=" + c.replace(/[-:]/g, ""), "css");
    var fa = function(b) {
        this._id = b.id;
        this._pid = b.pid || "";
        this._url = b.url;
    ...
    Ca.prototype = {
        init: function(b, c) {
            ...
            d.config.poster ? f.src = d.config.poster: b.data.error ? null != b.data.error && -203 == b.data.error.code && (this.container.poster.style.backgroundColor = "black", f.parentNode.removeChild(f), d.show(this.container.poster)) : (f.src = b.data.video.logo, this.container.poster.style.display = "block");
            ...
            this._feedbackPanel = new S(this.player, b);
        ...
        autoHideDashBoard: function(b) {
            ...
            this.dashboardTimer = setTimeout(function() {
                var f = d.get(".x-showlist");
                f && "block" == f.style.display ? c.autoHideDashBoard(b) : c.player.video.paused || c.hideDashBoard()
            },
            b || 2E3)
        },
        ...
        bindEvent: function() {
            ...
            "directsrc" == d.config.playType && (!f.isIPHONE && !f.isIPOD ? d.addEventHandler(this.buttons.videobtn, "click", this.bind_redirect, !0) : d.addEventHandler(this.buttons.videobtn, "click", d.bindAsEventListener(this, this.playIPH), !0));
        ...
        rePlay: function() {
            ...
            z = !1; (this._recommend = d.get(".x-recommend")) && d.get("#x-player").removeChild(this._recommend);
            this.resetProgress();
            this._first = !1;
            this.player.replay();
        ...
        onPlayEnd: function() {
            if (f.playerCurrentState != f.playerState.PLAYER_STATE_END && (this.playLimit._limitVip && (this.playLimit._isLimit = !1), f.playerCurrentState = f.playerState.PLAYER_STATE_END, d.config.events && d.config.events.onPlayEnd)) g.log("callback: on play end"),
        ...
        shadowTouchMove: function(b) {
            ...
            if (1 < b.targetTouches.length) this.interactionPanel.hide();
                ...
                if (1 != this._sactionType) if (100 < c && c > d && 500 > f) g.log("quick seek moving"),
                this.player.video.pause(),
                this._sactionType = 1,
                f = this._smx > this._sx ? 30 : -30,
                this.interactionPanel.setTip(this._stime, f),
                this.interactionPanel.show();
                else if (200 > c && (100 > d && 1E3 < f) && (this._spretag = !0), this._spretag && c > d || this._stmtag) g.log("stmtag =" + this._stmtag),
                this._sactionType = 2,
                this._stmtag = !0,
                this.player.video.pause(),
                this.dragging(b)
        ...
        dragging_: function(b) {
            ...
            for (var f = c = 0; f < this._deltaxs.length; f++) c += this._deltaxs[f];
        ...
        onEnterFullScreen: function() {
            f.isIPAD && d.addClass(this.setting.controls, "x-fs-console")
        },
        onExitFullScreen: function() {
            f.isIPAD && d.removeClass(this.setting.controls, "x-fs-console")
        },
        adrAdapt: function(b) {
            f.isAndroid && (this._smx = b.changedTouches[0].clientX, this._smy = b.changedTouches[0].clientY, g.log("<hr/>adr smy= " + this._smy + " y = " + this._sy))
        },
        ...
        uiInit: function() {
            g.log("uiInit");
            z && (z = !1, this.buttons.videobtn.style.display = "block")
        },
        onResize: function(b) {
            var c = r(d.config.parentBox).offsetWidth,
            f = r(d.config.parentBox).offsetHeight;
            if (c && (f && d.resizeTag) && (f = this.xplayer.className, this.xplayer && ( - 1 === f.indexOf("fullscreen") ? this.xplayer.className = F(c) : (c = window.innerWidth, this.xplayer.className = F(c) + " x-player-fullscreen")), this._relatedPanel)) this._relatedPanel.onResize(b)
        }
    };
    var W = function(b) {
        this.video = b;
    ...
    W.prototype = {
        ...
        onError: function() {
            ...
            f.playerCurrentState = f.playerState.PLAYER_STATE_ERROR,
            f.showError({
                code: "2001",
                message: "\u62b1\u6b49\uff0c\u89c6\u9891\u51fa\u9519\uff0c\u8bf7\u5237\u65b0"
            },
        ...
        onTimeUpdate: function(b) {
            ...
            d.unitedTag && (this.currentTime -= d.unitedTag.offset);
                ...
                for (var c = 0,
                g = 0; g < y; g++) c += parseInt(d.videoInfo._videoSegsDic.streams[d.defaultLanguage][d.defaultVideoType][g].seconds);
                this.currentTime = c + this.video.currentTime
            }
            this.controls.onTimeUpdate(b);
            this._firstflag || (this._firstflag = !0, this.customWaiting(), this.recordLocalPlayPoint(), this.sendLoadedTime(), j.appendItem("phase", "videotimeupdate"), f.isNeedAdrTrick() && f.adrInvalidPauseCheck(this.video));
            ...
            if (b.encodevid) {
                ...
                function(b, d) {
                    ...
                    try {
                        ...
                        u.log("onPlayerStart error")
                    }
                })
            }
        },
        onPlayEnd: function() {
            if (f.playerCurrentState != f.playerState.PLAYER_STATE_END) if (f.playerCurrentState = f.playerState.PLAYER_STATE_END, g.log(f.playerCurrentState), d.config.events && d.config.events.onPlayEnd && d.v.data.videos) g.log("callback: on play end"),
            d.config.events.onPlayEnd(d.v.data.videos.next);
            else if (d.config.loop && this.replay && (u.log("--loop--"), this.replay()), d.config.events && d.config.events.onPlayEnd) g.log("callback: on play end"),
            d.config.events.onPlayEnd()
        },
        onPlayStart: function() {
            f.playerCurrentState = f.playerState.PLAYER_STATE_PLAYING;
            d.config.events && d.config.events.onPlayStart && (g.log(f.playerCurrentState), g.log("callback: on play start"), d.config.events.onPlayStart())
        },
        onMiddleEnded: function() {
            y++;
            this.video.src = d.multiPieceSrc(y);
            this.video.load();
            this.video.play();
            this.video.style.display = "block";
        ...
        onEnded: function(b) {
            if (! (this.isOnePiece() && !0 == this.controls.checkPlayLimit())) if (this.isOnePiece() || y == d.videoInfo._videoSegsDic.streams[d.defaultLanguage][d.defaultVideoType].length - 1) z = !0,
            this._reporter.addPlayerDurationReport(61),
            this._reporter.sendTSLog(61),
            this._reporter.addClientDurationReport(61),
        ...
        onEndFullscreen: function() {
            if ((f.isIPHONE || f.isIPOD) && null != d.v.data.trial) this.video.style.display = "none"
        },
    ...
    d.addEventHandler = function(b, c, f, g) {
        d.config.isMobile && ("click" == c && !g) && (c = "touchend");
        b.addEventListener ? b.addEventListener(c, f, !1) : b.attachEvent ? b.attachEvent("on" + c, f) : b["on" + c] = f
    };
    d.removeEventHandler = function(b, c, f, g) {
        d.config.isMobile && ("click" == c && !g) && (c = "touchend");
        b.removeEventListener ? b.removeEventListener(c, f, !1) : b.detachEvent ? b.detachEvent("on" + c, f) : b["on" + c] = null
    };
    d.show = function(b) {
    ...
    d.m3u8src_v2 = function(b, c) {
        ...
        var i = encodeURIComponent(K(M(N(d.mk.a4 + "poz" + f.userCache.a2, [19, 1, 4, 7, 30, 14, 28, 8, 24, 17, 6, 35, 34, 16, 9, 10, 13, 22, 32, 29, 31, 21, 18, 3, 2, 23, 25, 27, 11, 20, 5, 15, 12, 0, 33, 26]).toString(), f.userCache.sid + "_" + b + "_" + f.userCache.token)));
        g.ep = i;
        g.sid = f.userCache.sid;
        g.token = f.userCache.token;
        g.ctype = "12";
        g.ev = "1";
        g.oip = d.v.data.security.ip;
        return "http://pl-ali.youku.com/playlist/m3u8?" + o(C(g, d.getUCParam(b)))
    };
    ...
    d.inherits(YoukuHTML5Player, W);
    d.extend(YoukuHTML5Player.prototype, {
        startPlay: function(b, c, f) {
            if (b && b.data && (b.data.show = b.data.show || {},
            c.abstarttime = (new Date).getTime(), c._playListData = b.data, c._user = b.user, d.v = b, d.videoInfo = c, d.extend(this.setting, f), !b.data.error || !this.processError(b, c, f))) {
                this._reporter = new T(this, d.v, d.videoInfo._sid);
        ...
        onUnitedFrontAdInfoOK: function(b) {
            ...
            this.unitedStartPlay(c, !0);
                ...
                var f = this;
                this.adplayer.addEventListener(D,
                function() {
                    f.controls.startPlay();
                    g.log("<font color=red>united ad end</font>");
                    f._realFlag || (f._realFlag = !0, f.adplayer.clearTimer(), f.unitedStartPlay(c))
                },
                !1);
                this.adplayer.addEventListener(A,
                function() {
                    g.log("<font color=red>united ad error</font>");
                    f._realFlag || (d.unitedTag = null, f._realFlag = !0, f.adplayer.clearTimer(), f.video.src = d.m3u8src_v2(d.v.data.id, d.defaultVideoType), f.unitedStartPlay(c, !0))
                },
                !1);
                this.adplayer.addEventListener(I,
                function() {
                    g.log("<b>ugly hint</b>");
                    f.onUglyCloseHint()
                },
        ...
        loadVTVC: function(b) {
            for (var c = 0; c < b.length; c++) E(b[c].VC, "js")
        },
        ...
        playVideos: function(b) {
            ...
            z = !1;
            y = 0;
            this.video.style.display = (f.isIPHONE || f.isIPOD) && null != d.v.data.trial ? "none": "block";
        ...
        processError: function(b) {
            ...
            this.feedbackPanel = new S(this, b);
            return ! 0
        },
        ...
        resize_: function(b, c, f) {
            g.log("resize=" + d.resizeTag);
            c && (f && d.resizeTag && this.controls) && (b = this.controls.xplayer.className, this.controls && this.controls.xplayer && ( - 1 === b.indexOf("fullscreen") ? this.controls.xplayer.className = F(c) : (c = window.innerWidth, this.controls.xplayer.className = F(c) + " x-player-fullscreen")))
        },
        uiAdapter: function() {
        ...
        replay: function() {
            ...
            this.video.style.display = "block";
            this.isOnePiece() || (this.video.src = d.multiPieceSrc(y));
            f.isIPAD && (this.video.src = d.m3u8src_v2(d.v.data.id, d.defaultVideoType), d.unitedTag = null);
            this.video.load();
            this.video.play();
        ...
        seekToLastPoint: function() {
            ...
            c = parseInt(c) || 0;
            return - 1 !== b && 120 <= b && 3 > c && !d.v.data.trial && b < d.videoInfo.totalTime - 120 ? (this.controls.showLastTimeTip(b), f.isAndroid && (this._waitSeek = b), this.seek(b), !0) : !1
        },
        ...
        skipHead: function() {
            if (!f.isAndroid) {
                ...
                g.log("skiphead = " + b); - 1 != b && (this.controls.tipPanel.onSkipHead(), "true" == j.getItem("youku_conf_skip") && (f.isAndroid && (this._waitSeek = b / 1E3), this.seek(b / 1E3)))
            }
        },
        skipTail: function(b) {
            if (!f.isAndroid) {
        ...
        multiSeekTo: function(b) {
            ...
            if (f == y) {
                ...
                this.video.addEventListener("canplay",
                function() {
                    1 !== l && (l = 1, g.log("canplay time=" + i), o.video.currentTime = i)
                }); (b = d.multiPieceSrc(y)) ? (this.video.src = b, this.video.load(), this.video.play()) : this.video.pause()
            }
            this.video.style.display = "block"
        },
            ...
            if (!f.isIOS) {
                ...
                setTimeout(function() {
                    ...
                    g.style.left = null;
                        ...
                        e = g.videoWidth / g.videoHeight;
                        isNaN(e) || isNaN(c) || !isFinite(c) || !isFinite(e) ? (g.style.width = "100%", g.style.height = "100%", g.style.top = null, g.style.left = null) : c < e ? (g.style.width = "100%", g.style.height = 100 * (c / e) + "%", g.style.top = 100 * (1 / c - 1 / e) / 2 * c + "%", g.style.left = null) : (g.style.height = "100%", g.style.width = 100 * (e / c) + "%", g.style.left = 100 * ((c - e) / 2 / c) + "%", g.style.top = null)
                    }
                },
                2E3)
            }
    ...
    window.QS = function() {
        ...
        if (null != c) for (var d = 0; d < c.length; d++) {
            ...
            if ("true" == f) f = !0;
            else if ("false" != f) if (isNaN(f)) {
                if ("string" == typeof f && /{[^{^}]{0,}}/.test(f)) try {
                    f = JSON.parse(f)
                } catch(l) {}
            } else f = +f;
            "undefined" == typeof b[j] ? b[j] = f: b[j] instanceof Array ? b[j].push(f) : b[j] = [b[j], f]
        }
        return b
    };
    window.YKP = f;
    ...
    for (var c = document.getElementsByTagName("script"), P = 0; P < c.length; P++) if ( - 1 !== c[P].src.indexOf("player.youku.com/jsapi")) {
        eval(c[P].innerHTML);
        break
    }
    ...
    window.onPlayerReady = function() {
        d.initConfig.events && d.initConfig.events.onPlayerReady && (f.playerCurrentState = f.playerState.PLAYER_STATE_READY, g.log(f.playerCurrentState), g.log("api:flash play ready"), d.initConfig.events.onPlayerReady())
    };
    window.onPlayerStart = function() {
        d.initConfig.events && d.initConfig.events.onPlayStart && (f.playerCurrentState = f.playerState.PLAYER_STATE_PLAYING, g.log(f.playerCurrentState), g.log("api:flash play start"), d.initConfig.events.onPlayStart())
    };
    window.onPlayerComplete = function() {
        d.initConfig.events && d.initConfig.events.onPlayEnd && (f.playerCurrentState = f.playerState.PLAYER_STATE_END, g.log(f.playerCurrentState), g.log("api:flash play end"), d.initConfig.events.onPlayEnd())
    };
    window.onPlayerError = function(b) {
        if (d.initConfig.events && d.initConfig.events.onPlayError && (f.playerCurrentState = f.playerState.PLAYER_STATE_ERROR, g.log(f.playerCurrentState), "4000" != (b.code || "1000"))) g.log("api:flash play error"),
