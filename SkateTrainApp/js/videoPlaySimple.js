...
// 	alert("1."+Zepto("#filmsource").attr("src"));
// 	Zepto("#filmsource").attr("src",'http://192.168.0.3//html5Video/video/Wildlife.mp4');
// 	alert("2."+Zepto("#filmsource").attr("src"));
	...
	var videoHeight = Zepto('#videoContainer').attr('offsetHeight');
 	...
 	Zepto('#videoMedia_block').css("height",videoHeight+"px");
	...
	function init() {
		...
		Zepto('#videoMediaDefaultImg').on('tap', function() {
			play();
		});
