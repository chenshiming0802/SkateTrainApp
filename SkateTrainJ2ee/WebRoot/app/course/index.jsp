...
for(int i=0,j=list.size();i<j;i++){
	...
	String lms = "select t.* ,(SELECT a.file_path FROM td_file a WHERE t.smallpic_file_id=a.id AND a.is_deleted='0') smallpic_file from td_course_daily_event t where t.is_deleted='0' and t.course_daily_id=?";
